...
Added `current_kernel_watchpoint_audit_v1.py` and `CURRENT_KERNEL_WATCHPOINT_AUDIT_REPORT_2026-05-22.md`. This did **not** change kernel behavior; it audited the diagnostic-map outputs and code paths to determine why some recent mechanisms change telemetry but not actions.
