# agents/co/core/elements/EJ_order_asymmetry.py
...
class EJ_OrderAsymmetry:
    WEIGHT_ROLE = "order-asymmetry penalty weighting"
    COMPOSITION_ROLE = "anti-cycle vote shaping"
    """
    Element wrapper for P15 (OrderAsymmetry):
