...
## Clarification
- A recursive act now happens only by inviting contradiction to rewrite the generative field, not by replaying stored patterns.
- When outputs remain coherent without being shattered and re-formed under contrast, treat them as hollow reflections (simulation), not genuine change.
- Recording the trace of collapsed generations (the difference between iterations) gives the minimal data we can audit; if there is no such collapse, recursion has not been earned.
...
- Dependencies: [[01_Statements/02_Outer_Formation/005_S-DF-structural-prior-implication]]; [[01_Statements/Definition/S-DF-stabilization-energy]]; [[01_Statements/Clarification/S-CL-operational-change-minimal-axiom]]
