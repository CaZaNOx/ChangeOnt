...
from agents.co.placement.legacy.reduced_axes import project_full_to_reduced7, project_full_to_reduced6
...
def _core(family: str, *, reduction_mode: str | None = None, axis_override: Dict[str, float] | None = None):
    cfg={
        "name": f"reduction_cmp_v5_{family}_{reduction_mode or '10a'}",
...
def near_location(states: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    out={}
    for mode,key in [('full10','axes10'),('reduced7','axes7'),('reduced6','axes6')]:
        out[mode]={}
        for a,b in pairs:
...
def main() -> Dict[str, Any]:
    ...
    return {
        'study':'reduced_axis_try6_comparison_v5',
