...
"""The canonical active path is experiments.suite_cli + experiments.runners + agents.co.integration.core_builder. suite_hooks is retained only for legacy compatibility.\n"""
