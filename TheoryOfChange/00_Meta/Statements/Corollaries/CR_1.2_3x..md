...
> This relaxation of PC to SC allows us to formulate structurally true statements by negating the x that would cause SC. This hold for any CoE(x) even if x is not causing a PC by expressing it currently.