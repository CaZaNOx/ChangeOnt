...
from agents.co.placement.legacy.reduced_axes import project_full_to_reduced7, project_full_to_reduced6, project_full_to_reduced5, project_full_to_reduced4, project_full_to_reduced1
            ...
            for t in range(8):
                ...
                if packet:
                    ...
                    out.append({'family':'bandit','variant':label,'seed':seed,'t':t,
                                ...
                                'axes1':project_full_to_reduced1(bundle['effective_axes'])})
...
def near_location(states: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    out={}
    for mode,key in [('full10','axes10'),('reduced7','axes7'),('reduced6','axes6'),('reduced5','axes5'),('reduced4','axes4'),('reduced1','axes1')]:
        out[mode]={}
        for a,b in pairs:
...
def main() -> Dict[str, Any]:
    ...
    return {
        'study':'reduced_axis_try1_comparison_v7',
