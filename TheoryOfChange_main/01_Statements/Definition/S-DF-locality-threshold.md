...
Recursive truth and identity checks rely on stable neighborhoods (see [[01_Statements/Definition/S-DF-localreach-topology]]). If σ(ε) swamps discrimination, Sim and reach lose reliability; bounded recursion prevents overclaiming and routes failure to collapse handling instead of silent drift.
