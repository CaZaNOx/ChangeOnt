...
Report: CURRENT_KERNEL_DIAGNOSTIC_MAP_REPORT_2026-05-22.md
...
- `CURRENT_KERNEL_TARGETED_HARDENING_REPORT_2026-05-22.md` records the DynamicShapeField readout-visibility fix, recursion provenance split, and deeper diagnostic trace logging.
...
- `DOMINANCE_READOUT_SWAMPING_AUDIT_UPDATE_2026-05-22.md` — compact handoff for the generic readout-swamping audit.
- `DOMINANCE_READOUT_SWAMPING_AUDIT_REPORT_2026-05-22.md` — report generated by `experiments.studies.dominance_readout_swamping_audit_v1`.
- `PREBLOCKING_RESOLVER_CROSS_FAMILY_MICROCASE_PROBE_REPORT_2026-05-22.md` — report generated by `experiments.studies.preblocking_resolver_cross_family_microcase_probe_v1`.
