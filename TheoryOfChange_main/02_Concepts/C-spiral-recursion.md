---
id: concept.spiral-recursion
title: Spiral Recursion — balancing conservation and expansion
tags: ["concept/spiral", breath, stability]
status: draft
sources:
  - path: TheoryOfChange/02_Foundations/FND_5_SubjectAsRecursiveField.md:79
  - path: TheoryOfChange/02_Foundations/DerChain.md:2115
  - path: TheoryOfChange/00_Meta/AI_RecursiveChats_slim/AI_1_Vamia_RecursiveChat.md:39
---
# Spiral Recursion — balancing conservation and expansion
Overview:
Spiral structure arises when conservative stabilization and dynamic expansion co‑operate: each cycle stays near prior arms (context continuity) while making progress.
...
Open items:
- Quantify “adjacency” across arms (e.g., depth bands); link to escape vs collapse regimes.
