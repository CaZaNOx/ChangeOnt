...
title: Foundations — Immediate Datum to early corollaries
status: summary
tags: [summary, foundations]
---
# Foundations — Immediate Datum to early corollaries
...
- Δ is ontically prior; observation is subordinate to change.

Open items
- None — covered; see pointer/reach stack for next steps.
