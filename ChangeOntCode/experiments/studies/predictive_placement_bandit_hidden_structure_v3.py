...
def _core(hidden_override=None):
    cfg={
        "name":"predictive_bandit_hidden_v3",
...
def main():
    ...
    out={"study":"predictive_placement_bandit_hidden_structure_v3","family":"bandit","axis":"hidden_structure_dependence","warmup_schedule":[0,1,2,3],"results":{}}
