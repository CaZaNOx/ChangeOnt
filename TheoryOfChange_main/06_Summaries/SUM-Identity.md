---
id: summary.identity
title: Identity — similarity, thresholds, SE, entropy
status: summary
tags: [summary, identity]
---
# Identity — similarity, thresholds, SE, entropy
...
Key takeaways
- Identity is “close enough over transformations” with declared criteria.
- SE measures loop robustness; entropy measures pathway variety.

Open items
- Empirical calibration guidance for θ, ε, σ(ε) per domain.
