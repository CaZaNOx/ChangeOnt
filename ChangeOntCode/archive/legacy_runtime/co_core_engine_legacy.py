"""
LEGACY / INACTIVE FILE
Moved out of the active runtime tree to reduce confusion.
This file is not part of the canonical supported runtime path.
"""
NOT_IN_ACTIVE_RUNTIME = True

"""The canonical runtime path is agents.co.integration.core_builder.build_co_core and adapter -> translator -> pipeline. engine.build_core is retained only for legacy compatibility.\n"""
LEGACY_INACTIVE = True
