---
id: concept.godel-holes
title: Gödel Holes — structural boundaries of detection
tags: [motif:godel-hole, domain:logical, layer:operators]
status: draft
---
Overview:
Points where a chain must reference something it cannot encode within the current space/subject structure; indicates missing operators or frame changes.

Canonical statements (to be linked):
- [[S-DF-godel-hole-pointer]] (DF)
- [[S-CR-nonclosure-under-tx]] (CR)
 - [[01_Statements/Definition/S-DF-godel-limits-self-containment]] (DF)

Dependencies:
- From: [[02_Concepts/C-markov-closure]]
- To: [[02_Concepts/C-frame-operators]]

Open items:
- Specify detection/marking protocol and quantify incidence under recursion.
