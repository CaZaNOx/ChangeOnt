---
id: stmt.cl-capacity-vs-instance-experience
type: CL
title: Distinguish capacity for experience from specific experiential content
concepts:
...
symbols_used: []
sources:
- path: TheoryOfChange/02_Foundations/FND_0_Phil-ImmediateDatum.md:262-340
flags: []
tags:
- layer/foundations
...
# Distinguish capacity for experience from specific experiential content

## Claim (formal)
The structural capacity to experience (the unified subject/awareness/experience structure) is distinct from any particular experienced content. The capacity is always present when an experiencing subject exists; specific contents arise as particular instances on that structure.
...
- Supports talking about continuity of the experiencer while accommodating changing experiential fields.

## Tags
#type/CL #layer/foundations #domain/phenomenology #concept/subject-awareness-experience
